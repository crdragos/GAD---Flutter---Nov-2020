...
class _$AppState extends AppState {
  ...
  _$AppState._({this.movies, this.isLoading, this.seeAll, this.showFilters})
      : super._() {
    if (movies == null) {
    ...
    if (seeAll == null) {
      throw new BuiltValueNullFieldError('AppState', 'seeAll');
    }
    if (showFilters == null) {
  ...
  int get hashCode {
    return $jf($jc(
        $jc($jc($jc(0, movies.hashCode), isLoading.hashCode), seeAll.hashCode),
...
class AppStateBuilder implements Builder<AppState, AppStateBuilder> {
  ...
  bool _seeAll;
  bool get seeAll => _$this._seeAll;
  set seeAll(bool seeAll) => _$this._seeAll = seeAll;
